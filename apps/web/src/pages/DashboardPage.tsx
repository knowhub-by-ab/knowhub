...
const STATS = [
  { label: "Nodes completed", value: "—", hint: "Connect a repo to begin" },
  { label: "Trees", value: "—", hint: "Create your first learning tree" },
  { label: "Assessments taken", value: "—", hint: "Test your knowledge" },
  { label: "Career readiness", value: "—", hint: "Pick a roadmap" },
];
